...
async def test_admin_delete_queue(service_client: Client):
    response = await service_client.delete(
        '/admin/v1/queues',
        headers={'Cookie': 'session_token=f37116c18a9345a0a2b5ea97fbc4e8f0'},
        json={'queue_id': '5d854c28-c6eb-4ed4-b429-aaf006cea6b5'}
    )
    ...
    response = await service_client.delete(
        '/admin/v1/queues',
        headers={'Cookie': 'session_token=f37116c18a9345a0a2b5ea97fbc4e8f0'},
        json={'queue_id': '6d854c28-c6eb-4ed4-b429-aaf006cea6b5'}
    )

    assert response.status == 404
    assert response.json() == {'code': '404', 'message': 'QUEUE_NOT_FOUND'}
