...
using Request = defs::auth::V1AuthLoginRequest;

using Response302 = formats::json::Value;
using Response200 = defs::auth::V1AuthLoginResponse;
...
public:
    static constexpr const std::string_view kName = "handler-v1_auth_login-post";
