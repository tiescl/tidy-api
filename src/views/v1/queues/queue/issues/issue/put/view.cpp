...
Response View::Handle(
    ...
    auto result = db::api::issues::UpdateIssue(pg_, user_id, queue_id, issue_id, issue);

    utils::HandleIssueQueryErrors(result.code);
    UINVARIANT(result.issue.has_value(), "updated issue must have a value at this point");
