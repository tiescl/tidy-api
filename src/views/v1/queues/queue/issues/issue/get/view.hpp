...
using Request = defs::queues::V1QueuesQueueIssuesIssueRequest;
using Response200 = defs::queues::V1QueuesQueueIssuesIssueResponse;
...
public:
    static constexpr std::string_view kName = "handler-v1_queues_queue_issues_issue-get";
