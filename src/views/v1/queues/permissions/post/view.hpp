...
using Request = V1QueuesPermissionsPostRequest;
using Response200 = V1QueuesPermissionsPostResponse;
...
public:
    static constexpr std::string_view kName = "handler-v1_queues_permissions-post";
