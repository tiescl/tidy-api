...
using Request = V1QueuesQueuePermissionsPostRequest;
using Response200 = V1QueuesQueuePermissionsPostResponse;
...
public:
    static constexpr std::string_view kName = "handler-v1_queues_queue_permissions-post";
